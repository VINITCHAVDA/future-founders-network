  ...
  return (
    <section className="page-shell narrow">
      ...
      <div className="feature-list">
        ...
        <div><strong>Events</strong><span>Register for mixers, workshops, pitch nights, and demo days.</span></div>
        <div><strong>Admin tools</strong><span>Manage users, chapters, events, posts, and memberships.</span></div>
      </div>
    </section>
  )
}
